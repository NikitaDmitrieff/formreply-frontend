      ...
      <section className="max-w-3xl mx-auto px-6 pb-16">
        <div className="border-t border-gray-100 pt-12">
          ...
          <div className="prose prose-gray prose-sm max-w-none text-gray-600 space-y-4">
            ...
            <p>
              These free tools help you handle the two biggest pain points: identifying
              spam submissions before they waste your time, and generating quick,
              professional replies to legitimate inquiries. Both run entirely in your
